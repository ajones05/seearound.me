...
class My_SlideShow
{
public $slideType = array('reveal_up','cover_up','drop','dissolve','pivot_left_top_up','pivot_left_bottom_up','spin','pivot_right_bottom_down','cover_right');
    
public function Insert_Slideshow( $flash_file, $php_source, $width=320, $height=240, $license=null ){
...
//====================================
public function Send_Slideshow_Data( $slideshow=array()){

...
echo $this->errmsg; exit;
    ...
    /**
     * Create thumbnail of image file to width, height, and quality
     *  
	 ...
	 * @param int $quality   
	 */
	public function createThumbnail($destPath, $width, $height, $quality=100){
		$this->resize($width, $height);
		$this->save($destPath, $quality);
	}
}
?>
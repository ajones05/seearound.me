...
jQuery.extend(Boxy, {
    ...
    WRAPPER:    "<table id='imageTable' cellspacing='0' cellpadding='0' border='0' class='boxy-wrapper'>" +
    ...
    DEFAULTS: {
        ...
        closeText:              '<img style="height:20px;width:20px;margin-top:-4px;margin-right:-3px;" src="'+baseUrl+'www/images/close2.jpg" />',      // text to use for default close link
